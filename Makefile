OBJECTS = $(DIR_O)/str_func.o $(DIR_O)/str_input.o $(DIR_O)/onegin.o $(DIR_O)/func_sort.o
CC = g++
...
$(DIR_O)/str_func.o: $(DIR_SOUR)/str_func.cpp $(DIR_SOUR)/str_func.h
	$(CC) $(CFLAGS) $< -o $@
...
$(DIR_O)/func_sort.o: $(DIR_SOUR)/func_sort.cpp $(DIR_SOUR)/func_sort.h
	$(CC) $(CFLAGS) $< -o $@
